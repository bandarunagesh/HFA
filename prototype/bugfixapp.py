...
def parse():
    ...
    try:
        ...
        if req_type.lower() != "prior_auth":
            ...
            ans = "Unanswered"
            sugg_list = []
            #if res_itent.lower() == "pa_denial_rsns_g":
            #    res_intent = "pa_denial_rsns"
            #elif res_itent.lower() == "pa_cancel_rsns_g":
            #    res_intent = "pa_cancel_rsns"
            #elif res_itent.lower() == "pa_approve_rsns_g":
            #    res_intent = "pa_approve_rsns"
...
if __name__ == "__main__":
    app.run(host='apsrp03693',port=8015,debug=True)
