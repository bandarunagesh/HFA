...
def getStatusPA(value):
    ...
    try:
        ...
        if n_records==n_denial_recds and n_records!=0:
            ...
            status="1}Your PA claim has been completely denied"+" on "+t.split('-')[2]+"th of "+t.split('-')[1] +", "+t.split('-')[0]+"!Denial Reason!Resubmit Procedure!TAT!Submission Mode"
            # print(status)
            return (status)
            ...
            for x in mydoc:
                t=x['total'].strftime('%Y-%b-%d')
            status="2}Your PA claim has been approved"+" on "+t.split('-')[2]+"th of "+t.split('-')[1] +", "+t.split('-')[0]+"!Denial Reason!Resubmit Procedure!TAT!Submission Mode"
            # print(status)
            return (status)
            ...
            for x in mydoc:
                t=x['total'].strftime('%Y-%b-%d')
            status="3}Your PA claim has been cancelled"+" on "+t.split('-')[2]+"th of "+t.split('-')[1] +", "+t.split('-')[0]+"!Denial Reason!Resubmit Procedure!TAT!Submission Mode"
            # print(status)
            return (status)
            ...
            for x in mydoc:
                t=x['total'].strftime('%Y-%b-%d')
            status="4}Your PA claim has been approved"+" on "+t.split('-')[2]+"th of "+t.split('-')[1] +", "+t.split('-')[0]+"!Denial Reason!Resubmit Procedure!TAT!Submission Mode"
            # print(status)
            return (status)
            ...
            for x in mydoc:
                t=x['total'].strftime('%Y-%b-%d')
            status="5}Your PA claim has been partially denied"+" on "+t.split('-')[2]+"th of "+t.split('-')[1] +", "+t.split('-')[0]+"!Denial Reason!Resubmit Procedure!TAT!Submission Mode"
            # print(status)
            return (status)
            ...
            for x in mydoc:
                t=x['total'].strftime('%Y-%b-%d')
            status="6}Your PA claim has been denied"+" on "+t.split('-')[2]+"th of "+t.split('-')[1] +", "+t.split('-')[0]+"!Denial Reason!Resubmit Procedure!TAT!Submission Mode"
            # print(status)
            return (status)
        elif n_records==0:
