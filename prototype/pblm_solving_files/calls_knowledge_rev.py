        ...
        if context_call_r_calls.upper()=="CALL":
            ...
            for i in range(0,len(s2)):
                ...
                if s1_i_orig in ["tat"]:
                    ...
                    s3=s3+" "+"count".lower()+" "
                elif s1_i_crcted in ['dial','dialled','dialling','receipt','receive','received','receiving','receives','receiving','collect','collects','collected','collecting','gather','gathers','gathering','gathered']:
