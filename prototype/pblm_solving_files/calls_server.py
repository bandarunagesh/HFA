    ...
    try:
        ...
        if 'queries' in s1.lower().split(' ') and 'related' in s1.lower().split(' ') and 'to' in s1.lower().split(' ') and 'calls' in s1.lower().split(' '):
            ...
            if ts=="no conversation history found":
                ...
                kv_calls=[]
                kv_calls.append("Do you want to continue with old call id")
                kv_calls.append(conv_obj_id)
                kv_calls.append(sugg_list)
                return kv_calls
        ...
        if s1.lower()=="yes":
            ...
            if ts=="Queries related to Calls":
                ...
                conv_obj_id=calls_push_conv_hist(conv_uid,conv_sesid,conv_question,conv_answer,conv_intent,conv_int_conf,conv_like_r_dislike)
                kv_calls=[]
                kv_calls.append("Please enter call id")
                kv_calls.append(conv_obj_id)
                kv_calls.append([])
                return kv_calls
        ...
        if True:
            ...
            if str(call_id)=='0':
                ...
                if call_id_flag:
                    ...
                    conv_obj_id=calls_push_conv_hist(conv_uid,conv_sesid,conv_question,conv_answer,conv_intent,conv_int_conf,conv_like_r_dislike)
                    kv_calls=[]
                    kv_calls.append("There is no Call Information available with provided Call ID")
                    kv_calls.append(conv_obj_id)
                    kv_calls.append([])
                    return kv_calls
        ...
        if "information" in um_arr and "status" in um_arr and "call" in um_arr:
            ...
            if res_intent=="calls_cnt_bu":
                if "top" in um_arr:
                    res_intent="top_calls_bu"
        ...
        if res_intent=="call_info":
            ...
            sugg_list.append("Did the call get answered?")
            sugg_list.append("When  was the call dialled in?")            
            sugg_list.append("What was the total duration of the call?")            

        elif res_intent=="call_received_date":

            ans=get_call_received_date(res_call_id)
            sugg_list.append("Did the call get answered?")
            sugg_list.append("What is the product type being enquired in the call?")
            sugg_list.append("What was the total duration of the call?")
            ...
            sugg_list.append("What is the product type being enquired in the call?")
            sugg_list.append("What is the talk-time for the call?")
            sugg_list.append("In which language was the call answered?")
            
        elif res_intent=="call_time":

            ans=get_call_time(res_call_id)
            sugg_list.append("What is the ring-time for the call?")
            sugg_list.append("What is the hold-time for the call?")
            sugg_list.append("To what category does the call belong to?")            

        elif res_intent=="call_type":

            ans=get_call_type(res_call_id)
            sugg_list.append("Did the call get transferred?")
            sugg_list.append("What was the total duration of the call?")
            sugg_list.append("What is the product type being enquired in the call?")
            ...
            sugg_list.append("The call is related to which Business Unit?")
            sugg_list.append("What is the talk-time for the call?")
            sugg_list.append("In which language was the call answered?")
            ...
            sugg_list.append("What was the total duration of the call?")
            sugg_list.append("To which Line of Business does the call pertain to?")
            sugg_list.append("The call is related to which Business Unit?")
            ...
            if context_from.upper()=="default".upper():
                ...
                dur_list.append(context_to)
                dur_list.append("junk")                        
            ans=get_top_calls_total_time_int(dur_list,n,provider_lst)
            ...
            if context_from.upper()=="default".upper():
                ...
                dur_list.append(context_to)
                dur_list.append("junk")                        
            ans=get_top_calls_talk_time_int(dur_list,n,provider_lst)
            ...
            if context_from.upper()=="default".upper():
                ...
                dur_list.append(context_to)
                dur_list.append("junk")                        
            ans=get_top_calls_ring_time_int(dur_list,n,provider_lst)
            ...
            n=5
            if context_from.upper()=="default".upper():
                print("entered if to test for days present "+str(context_days))
                dur_list.append(context_days)
                dur_list.append(context_months)
                dur_list.append(context_years)
                dur_list.append("junk")
                ...
                print("entered else to test for days present")
                dur_list.append(context_from)
                dur_list.append(context_to)
                dur_list.append("junk") 
            print("value of n is "+str(n))                       
            ans=get_top_calls_hold_time_int(dur_list,n,provider_lst)
            ...
            ans=get_top_calls_bu(dur_list,n,provider_lst)
