...
import ast
def calls_push_conv_hist(userid,sess_id,quest,resp,intnt,conf,like_r_dislke):
    ...
    mycol = mydb["Calls_Conversation_History"]
...
def calls_pop_conv_hist(userid,sess_id):
