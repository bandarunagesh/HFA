...
def main_fun(userid,sessid,req,prov_lst,req_chart_type):
    ...
    if intnt1.lower()=='claims_count':  
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_vol_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_vol_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_vol_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_vol_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_vol_trend"

        elif 'paid' in s1 or 'adjudicated' in s1:
        ...
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_val_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_val_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_val_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_val_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_val_trend"
        ...
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_type_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_type_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_type_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_type_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_type_trend"
        ...
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_lob_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_lob_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_lob_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_lob_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_lob_trend"
        ...
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_par_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_par_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_par_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_par_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_par_trend"
        ...
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_diag_cd_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_diag_cd_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_diag_cd_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_diag_cd_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_diag_cd_trend"
        ...
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_tat_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_tat_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_tat_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_tat_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_tat_trend"
        ...
        if ('high' in s1 and 'dollar' in s1) and ('paid' in s1 or 'adjudicated' in s1):
            intnt="hgh_dlr_paid_claim_submsn_mode_trend"
        elif ('high' in s1 and 'dollar' in s1) and "adjusted" in s1:
            intnt="hgh_dlr_adjstd_claim_submsn_mode_trend"
        elif ('high' in s1 and 'dollar' in s1) and "partial denied" in s1:
            intnt="hgh_dlr_prtl_dend_claim_submsn_mode_trend"
        elif ('high' in s1 and 'dollar' in s1) and "denied" in s1:
            intnt="hgh_dlr_dend_claim_submsn_mode_trend"
        elif ('high' in s1 and 'dollar' in s1) and ('received' in s1 or 'submitted' in s1):
            intnt="hgh_dlr_rcvd_claim_submsn_mode_trend"
        ...
        if ('high' in s1 and 'dollar' in s1) and 'denied' in s1 and 'partial' in s1:
            if req_chart_type.lower()=="bar_chart_requested":
                intnt="hgh_dlr_prtl_dend_reasons_trend_bar"
            else:
                intnt="hgh_dlr_prtl_dend_reasons_trend"
            
        elif ('high' in s1 and 'dollar' in s1) and 'denied' in s1:
            if req_chart_type.lower()=="bar_chart_requested":
                intnt="hgh_dlr_dend_reasons_trend_bar"
            else:
                intnt="hgh_dlr_dend_reasons_trend"            
        elif ('high' in s1 and 'dollar' in s1) and 'adjusted' in s1:
            if req_chart_type.lower()=="bar_chart_requested":
                intnt="hgh_dlr_adjstd_reasons_trend_bar"
            else:
                intnt="hgh_dlr_adjstd_reasons_trend"


        elif 'denied' in s1 and 'partial' in s1:
            if req_chart_type.lower()=="bar_chart_requested":
    ...
    elif intnt=="hgh_dlr_rcvd_claim_vol_trend":
        return get_hgh_dlr_rcvd_claim_vol_trend(dur_lst,prov_lst)
    elif intnt=="hgh_dlr_adjstd_reasons_trend_bar":
        return get_hgh_dlr_adjstd_reasons_trend_bar(dur_lst,prov_lst)
    elif intnt=="hgh_dlr_prtl_dend_reasons_trend_bar":
        return get_hgh_dlr_prtl_denial_reasons_trend_bar(dur_lst,prov_lst)
    elif intnt=="hgh_dlr_dend_reasons_trend_bar":
        return get_hgh_dlr_denial_reasons_trend_bar(dur_lst,prov_lst)
    elif intnt=="hgh_dlr_rcvd_claim_val_trend":
        return (get_hgh_dlr_rcvd_claim_val_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_rcvd_claim_type_trend":
        return (get_hgh_dlr_rcvd_claim_type_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_rcvd_claim_lob_trend":
        return (get_hgh_dlr_rcvd_claim_lob_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_rcvd_claim_par_trend":
        return (get_hgh_dlr_rcvd_claim_par_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_rcvd_claim_diag_cd_trend":
        return (get_hgh_dlr_rcvd_claim_diag_cd_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_rcvd_claim_tat_trend":
        return (get_hgh_dlr_rcvd_claim_tat_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_rcvd_claim_submsn_mode_trend":
        return (get_hgh_dlr_rcvd_claim_submsn_mode_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_vol_trend":
        return (get_hgh_dlr_paid_claim_vol_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_val_trend":
        return (get_hgh_dlr_paid_claim_val_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_type_trend":
        return (get_hgh_dlr_paid_claim_type_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_lob_trend":
        return (get_hgh_dlr_paid_claim_lob_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_par_trend":
        return (get_hgh_dlr_paid_claim_par_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_diag_cd_trend":
        return (get_hgh_dlr_paid_claim_diag_cd_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_tat_trend":
        return (get_hgh_dlr_paid_claim_tat_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_paid_claim_submsn_mode_trend":
        return (get_hgh_dlr_paid_claim_submsn_mode_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_vol_trend":
        return (get_hgh_dlr_dend_claim_vol_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_val_trend":
        return (get_hgh_dlr_dend_claim_val_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_type_trend":
        return (get_hgh_dlr_dend_claim_type_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_lob_trend":
        return (get_hgh_dlr_dend_claim_lob_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_par_trend":
        return (get_hgh_dlr_dend_claim_par_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_diag_cd_trend":
        return (get_hgh_dlr_dend_claim_diag_cd_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_tat_trend":
        return (get_hgh_dlr_dend_claim_tat_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_claim_submsn_mode_trend":
        return (get_hgh_dlr_dend_claim_submsn_mode_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_vol_trend":
        return (get_hgh_dlr_prtl_dend_claim_vol_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_val_trend":
        return (get_hgh_dlr_prtl_dend_claim_val_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_type_trend":
        return (get_hgh_dlr_prtl_dend_claim_type_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_lob_trend":
        return (get_hgh_dlr_prtl_dend_claim_lob_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_par_trend":
        return (get_hgh_dlr_prtl_dend_claim_par_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_diag_cd_trend":
        return (get_hgh_dlr_prtl_dend_claim_diag_cd_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_tat_trend":
        return (get_hgh_dlr_prtl_dend_claim_tat_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_claim_submsn_mode_trend":
        return (get_hgh_dlr_prtl_dend_claim_submsn_mode_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_vol_trend":
        return (get_hgh_dlr_adjstd_claim_vol_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_val_trend":
        return (get_hgh_dlr_adjstd_claim_val_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_type_trend":
        return (get_hgh_dlr_adjstd_claim_type_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_lob_trend":
        return (get_hgh_dlr_adjstd_claim_lob_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_par_trend":
        return (get_hgh_dlr_adjstd_claim_par_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_diag_cd_trend":
        return (get_hgh_dlr_adjstd_claim_diag_cd_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_tat_trend":
        return (get_hgh_dlr_adjstd_claim_tat_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_claim_submsn_mode_trend":
        return (get_hgh_dlr_adjstd_claim_submsn_mode_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_adjstd_reasons_trend":
        return (get_hgh_dlr_adjstd_reasons_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_dend_reasons_trend":
        return (get_hgh_dlr_denial_reasons_trend(dur_lst,prov_lst))
    elif intnt=="hgh_dlr_prtl_dend_reasons_trend":
        return (get_hgh_dlr_prtl_denl_reasons_trend(dur_lst,prov_lst))
...
def get_recvd_dend_claim_val_trend(dur_lst,provider_lst):
...
def get_dend_rate_val_rate(dur_lst,provider_lst):

    rcvd_res=get_rcvd_claim_val_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_recvd_dend_claim_val_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_payment_val_rate(dur_lst,provider_lst):
    rcvd_res=get_rcvd_claim_val_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_rcvd_claim_paid_val_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
    ...
    kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
    kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
    kv=kv+"'"+str("Title")+"'"+":"+"'"+str("Claims Trend (Payment Value Rate)")+"'"+","
    kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Line")+"'"+","
    kv=kv+"'"+str("Header")+"'"+":"+""+str(key_lst)+""+","
    kv=kv+"'"+str("Value")+"'"+":"+""+str(val_lst_rate)+""+","
    kv=kv[0:len(kv)-1]+"}"
...
def get_rcvd_paid_claim_tat_trend(dur_lst,provider_lst):
...
def get_payment_claim_tat_rate(dur_lst,provider_lst):
    rcvd_res=get_rcvd_claim_tat_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_rcvd_paid_claim_tat_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_recvd_dend_claim_tat_trend(dur_lst,provider_lst):
...
def get_denied_claim_tat_rate(dur_lst,provider_lst):
    rcvd_res=get_rcvd_claim_tat_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_recvd_dend_claim_tat_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_rcvd_paid_claim_type_trend(dur_lst,provider_lst):
...
def get_payment_claim_type_rate(dur_lst,provider_lst):
    rcvd_res=get_rcvd_claim_type_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_rcvd_paid_claim_type_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
    ...
    for i in range(0,len(key_lst)):
        hit=0
        for j in range(0,len(key_lst_rcvd_paid)):
            if str(key_lst[i])==str(key_lst_rcvd_paid[j]):
                hit=1
                try:
                    temp=int(val_lst_rcvd_paid[j])/int(val_lst_rcvd[i])*100
                    temp=round(temp,2)
                except:
                    temp=0
                val_lst_rate.append(temp)
        if hit==0:
            val_lst_rate.append(0)
    kv="{"
    kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
    kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
    kv=kv+"'"+str("Title")+"'"+":"+"'"+str("Claims Volume Rate (By Claim Type)")+"'"+","
    kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Line")+"'"+","
    kv=kv+"'"+str("Header")+"'"+":"+""+str(key_lst)+""+","
    kv=kv+"'"+str("Value")+"'"+":"+""+str(val_lst_rate)+""+","
    kv=kv[0:len(kv)-1]+"}"
...
def get_recvd_dend_claim_type_trend(dur_lst,provider_lst):
...
def get_denied_claim_type_rate(dur_lst,provider_lst):
    rcvd_res=get_rcvd_claim_type_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_recvd_dend_claim_type_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_recvd_dend_claim_par_trend(dur_lst,provider_lst):
...
def get_denied_claim_par_rate(dur_lst,provider_lst):

    rcvd_res=get_rcvd_claim_par_trend(dur_lst,provider_lst)    
    rcvd_paid_res=get_recvd_dend_claim_par_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
    ...
    kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
    kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
    kv=kv+"'"+str("Title")+"'"+":"+"'"+str("Claims Volume Rate (By Par Status)")+"'"+","
    kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Line")+"'"+","
    kv=kv+"'"+str("Header")+"'"+":"+""+str(key_lst)+""+","
    kv=kv+"'"+str("Value")+"'"+":"+""+str(val_lst_rate)+""+","
    kv=kv[0:len(kv)-1]+"}"
...
def get_rcvd_paid_claim_par_trend(dur_lst,provider_lst):
...
def get_payment_claim_par_rate(dur_lst,provider_lst):

    rcvd_res=get_rcvd_claim_par_trend(dur_lst,provider_lst)    
    rcvd_paid_res=get_rcvd_paid_claim_par_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_rcvd_paid_claim_submsn_mode_trend(dur_lst,provider_lst):
...
def get_payment_claim_submsn_mode_rate(dur_lst,provider_lst):

    rcvd_res=get_rcvd_claim_submsn_mode_trend(dur_lst,provider_lst)    
    rcvd_paid_res=get_rcvd_paid_claim_submsn_mode_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
    ...
    kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
    kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
    kv=kv+"'"+str("Title")+"'"+":"+"'"+str("Claims Volume Rate (By Submission Mode)")+"'"+","
    kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Line")+"'"+","
    kv=kv+"'"+str("Header")+"'"+":"+""+str(key_lst)+""+","
    kv=kv+"'"+str("Value")+"'"+":"+""+str(val_lst_rate)+""+","
    kv=kv[0:len(kv)-1]+"}"
...
def get_recvd_dend_claim_submsn_mode_trend(dur_lst,provider_lst):
...
def get_denied_claim_submsn_mode_rate(dur_lst,provider_lst):

    rcvd_res=get_rcvd_claim_submsn_mode_trend(dur_lst,provider_lst)    
    rcvd_paid_res=get_recvd_dend_claim_submsn_mode_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_rcvd_claims_top_delayed(dur_lst,provider_lst):
    ...
    try:
        ...
        if len(dur_lst)==3:
            ...
            while True:
                ...
                if len(provider_lst) > 0:
                    ...
                    cond="{'$and':["+cond+"]}"
                cond1=cond
                cond=cond+",{'$gt':['$fromdatetopaiddate',60]}"
                my_dict = ast.literal_eval(cond)  
                print(cond)
                mydoc = mycol.find(cond)                
                claims_gt_60=claims_gt_60+mydoc.count()                
                cond=cond1+",{'$gt':['$fromdatetopaiddate',90]}"
                my_dict = ast.literal_eval(cond)  
                mydoc = mycol.find(cond)
                claims_gt_90=claims_gt_90+mydoc.count()                
                cond=""
                mon_strt=mon_strt+1
                print(type(mon_strt))
                print((mon_strt))
        ...
        key_lst=['>60','>90']
        val_lst=[]
        val_lst.append(claims_gt_60)
        val_lst.append(claims_gt_90)
        kv="{"
        kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
        kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
        kv=kv+"'"+str("Title")+"'"+":"+"'"+str("Top Delayed Claims (By TAT)")+"'"+","
        kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Bar")+"'"+","
        kv=kv+"'"+str("Header")+"'"+":"+""+str(key_lst)+""+","
        kv=kv+"'"+str("Value")+"'"+":"+""+str(val_lst)+""+","
        kv=kv[0:len(kv)-1]+"}"
...
def get_rcvd_claims_tat_bucketing(dur_lst,provider_lst):
        ...
        if len(dur_lst)==3:
            ...
            while True:
                ...
                if len(provider_lst) > 0:
                    ...
                    cond="{'$and':["+cond+"]}"
                cond1=cond
                cond=cond+",{'$gt':['$fromdatetopaiddate',0]}"
                cond=cond+",{'$lt':['$fromdatetopaiddate',31]}"
                my_dict = ast.literal_eval(cond)  
                print(cond)
                mydoc = mycol.find(cond)                
                claims_0_30=claims_0_30+mydoc.count() 
                cond=cond1+",{'$gt':['$fromdatetopaiddate',30]}"
                cond=cond+",{'$lt':['$fromdatetopaiddate',61]}"
                my_dict = ast.literal_eval(cond)  
                print(cond)
                mydoc = mycol.find(cond)                
                claims_31_60=claims_31_60+mydoc.count() 
                cond=cond1+",{'$gt':['$fromdatetopaiddate',60]}"
                cond=cond+",{'$lt':['$fromdatetopaiddate',91]}"
                my_dict = ast.literal_eval(cond)  
                print(cond)
                mydoc = mycol.find(cond)                
                claims_61_90=claims_61_90+mydoc.count()               
                cond=cond1+",{'$gt':['$fromdatetopaiddate',90]}"
                my_dict = ast.literal_eval(cond)  
                mydoc = mycol.find(cond)
                claims_gt_90=claims_gt_90+mydoc.count()                
            ...
            for dl in dur_lst[2]:
                for dl1 in dur_lst[1]:
                    ...
                    mydoc = mycol.find(cond)
                    claims_gt_90=claims_gt_90+mydoc.count() 
        key_lst=['0-30','31-60','61-90','>90']
        val_lst=[]
        val_lst.append(claims_0_30)
        val_lst.append(claims_31_60)
        val_lst.append(claims_61_90)
        val_lst.append(claims_gt_90)
        kv="{"
        kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
        kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
        kv=kv+"'"+str("Title")+"'"+":"+"'"+str("Claims Trend (By TAT)")+"'"+","
        kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Bar")+"'"+","
        kv=kv+"'"+str("Header")+"'"+":"+""+str(key_lst)+""+","
        kv=kv+"'"+str("Value")+"'"+":"+""+str(val_lst)+""+","
        kv=kv[0:len(kv)-1]+"}"
...
def get_hgh_dlr_rcvd_claim_vol_trend(dur_lst,provider_lst):
    ...
    try:
        ...
        if len(dur_lst)==3:
            ...
            while True:
                ...
                cond=cond+"{'received_date':{'$regex':'.*-"+str(mon_frmt)+"-.*'}}"
                cond=cond+",{'received_date':{'$regex':'"+str(yr_strt)+"-.*-.*'}}"
                cond=cond+",{'claim_high_dollar_paid_ind':'1'}"
                if len(provider_lst) > 0:
                    pc=",{'payto_provider_tax_id':{'$in':"+str(provider_lst)+"}}"
                    cond="{'$and':["+cond+pc+"]}"
                else:
...
def get_hgh_dlr_rcvd_claim_val_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_rcvd_claim_type_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_rcvd_claim_lob_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_rcvd_claim_par_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_rcvd_claim_diag_cd_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_rcvd_claim_tat_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_rcvd_claim_submsn_mode_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_vol_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_val_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_type_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_lob_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_par_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_diag_cd_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_tat_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_paid_claim_submsn_mode_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_vol_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_val_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_type_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_lob_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_par_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_diag_cd_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_tat_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_claim_submsn_mode_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_vol_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_val_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_type_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_lob_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_par_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_diag_cd_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_tat_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_dend_claim_submsn_mode_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_vol_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_val_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_type_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_lob_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_par_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_diag_cd_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_tat_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_claim_submsn_mode_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_adjstd_reasons_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_denl_reasons_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_denial_reasons_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_denial_reasons_trend_bar(dur_lst,provider_lst):
...
def get_hgh_dlr_prtl_denial_reasons_trend_bar(dur_lst,provider_lst):
...
def get_hgh_dlr_rcvd_paid_claim_vol_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_payment_vol_rate(dur_lst,provider_lst):
    rcvd_res=get_hgh_dlr_rcvd_claim_vol_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_hgh_dlr_rcvd_paid_claim_vol_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_hgh_dlr_rcvd_dend_claim_vol_trend(dur_lst,provider_lst):
...
def get_hgh_dlr_dend_rate_vol_rate(dur_lst,provider_lst):
    rcvd_res=get_hgh_dlr_rcvd_claim_vol_trend(dur_lst,provider_lst)
    rcvd_paid_res=get_hgh_dlr_rcvd_dend_claim_vol_trend(dur_lst,provider_lst)
    r_from_dt=rcvd_res["From"]
    print(str(r_from_dt))
    r_end_dt=rcvd_res["End"]
    print(str(r_end_dt))
...
def get_hgh_dlr_adjstd_reasons_trend_bar(dur_lst,provider_lst):
...
def get_rcvd_claims_vol_all_providers(dur_lst):    
    ...
    try:
        ...
        if len(dur_lst)==3:
            ...
            while True:
                ...
                print(cond)
                my_dict = ast.literal_eval(cond)  
                pipe = [{'$match':my_dict},{'$group': {'_id':'$payto_provider_tax_id', 'total': {'$sum': 1}}},{'$sort': {'total':-1}}] ## sum after type conversion of field                              
                mydoc=(mycol.aggregate(pipeline=pipe))
                n_records=""
                top_cnt=0
                for x in mydoc:                    
        ...
        for c in range(0,len(claim_type_lst)):
            a=[]
            a.append(claim_type_lst[c])
            a.append(cliam_type_cnt_lst[c])
            op_lst.append(a)
        ...
        kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
        kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
        kv=kv+"'"+str("Title")+"'"+":"+"'"+str("Submitted Claims Volume (By Provider)")+"'"+","
        kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Bar")+"'"+","
        kv=kv+"'"+str("Header")+"'"+":"+""+str(claim_type_lst[0:5])+""+","
        kv=kv+"'"+str("Value")+"'"+":"+""+str(cliam_type_cnt_lst[0:5])+""+","
        kv=kv[0:len(kv)-1]+"}"
        print(kv)
        kv=ast.literal_eval(kv)
        return kv
...
# print(get_rcvd_claims_vol_all_providers([[],[],['2018'],[]]))

def get_paid_claims_vol_all_providers(dur_lst):    
    ...
    try:
        ...
        kv=kv+"'"+str("From")+"'"+":"+"'"+str(r_from_dt)+"'"+","
        kv=kv+"'"+str("End")+"'"+":"+"'"+str(r_end_dt)+"'"+","
        kv=kv+"'"+str("Title")+"'"+":"+"'"+str("paid Claims Volume (By Providers)")+"'"+","
        kv=kv+"'"+str("Graph Type")+"'"+":"+"'"+str("Bar")+"'"+","
        kv=kv+"'"+str("Header")+"'"+":"+""+str(claim_type_lst[0:5])+""+","
        kv=kv+"'"+str("Value")+"'"+":"+""+str(cliam_type_cnt_lst[0:5])+""+","
        kv=kv[0:len(kv)-1]+"}"
...
print(get_paid_claims_vol_all_providers([[],[],['2018'],[]]))